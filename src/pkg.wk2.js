...
export function main(ns) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const securityDecrease = yield ns.weaken(target.id);
...
function waitUntilTimestamp(ns, msgHeader, landingTime, target, log) {
    return __awaiter(this, void 0, void 0, function* () {
        if (landingTime) {
            let fireIn = (landingTime - performance.now()) - target.wk.duration;
...
function logJobCompletion(msgHeader, securityDecrease, log) {
...
//# sourceMappingURL=pkg.wk2.js.map