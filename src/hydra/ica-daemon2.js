...
class Ica {
    ...
    #updateTheoreticalServerState() {
        const [theoreticalSecurityDecrease, theoreticalMoneyIncrease] = this.#getTheoreticalServerChanges();
    ...
    #logTargetStatus(blockId, stepId) {
