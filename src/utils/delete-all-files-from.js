...
function eraseAllFilesFromAServer(ns, hostname) {
    if (hostname == 'home') {
...
function eraseAFile(ns, fileName, hostname, extensionToKeep = ['.cct']) {
...
//# sourceMappingURL=delete-all-files-from.js.map